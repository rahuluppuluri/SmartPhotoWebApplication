...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://b0zf26u9ga.execute-api.us-west-2.amazonaws.com/dev';
    var invokeUrl = 'https://sdwrpgy3xi.execute-api.us-west-2.amazonaws.com/dev'
    var invokeUrl = 'https://55jg76qlba.execute-api.us-west-2.amazonaws.com/dev'
    var invokeUrl = 'https://vdnm5njp4h.execute-api.us-west-2.amazonaws.com/dev'
    ...
    apigClient.uploadBucketKeyOptions = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['Access-Control-Allow-Origin', 'Access-Control-Allow-Headers', 'Access-Control-Allow-Credentials', 'Access-Control-Allow-Methods'], ['body']);
        ...
        var uploadBucketKeyOptionsRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Access-Control-Allow-Origin', 'Access-Control-Allow-Headers', 'Access-Control-Allow-Credentials', 'Access-Control-Allow-Methods']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
